...
public class NotificationController {
    ...
    @PostMapping("/get-all")
    public ResponseEntity<ApiResponseDto<NotificationGetAllRespDto>> getAll(Long userId) {
        NotificationGetAllRespDto notificationGetAllRespDto = notificationService.getAllNotifications(userId);
    ...
    public ResponseEntity<ApiResponseDto<List<NotificationRespDto>>> getFriend(Long userId) {
        List<NotificationRespDto> notificationRespDtos = notificationService.getAllFriendNotifications(userId);
