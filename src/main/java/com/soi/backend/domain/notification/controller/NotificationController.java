...
public class NotificationController {
    ...
    @PostMapping("/get-all")
    public ResponseEntity<ApiResponseDto<NotificationGetAllRespDto>> getAll(@AuthenticationPrincipal Long userId, int page) {
    ...
    public ResponseEntity<ApiResponseDto<List<NotificationRespDto>>> getFriend(@AuthenticationPrincipal Long userId, int page) {
